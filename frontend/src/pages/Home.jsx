...
const Home = () => {
    ...
    const CARD_ICONS = {
        bolt: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" fill="none" stroke="currentColor" strokeWidth="2" /></svg>,
        check: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" fill="none" stroke="currentColor" strokeWidth="2" /><polyline points="22 4 12 14.01 9 11.01" fill="none" stroke="currentColor" strokeWidth="2" /></svg>,
        users: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" fill="none" stroke="currentColor" strokeWidth="2" /><circle cx="9" cy="7" r="4" fill="none" stroke="currentColor" strokeWidth="2" /></svg>,
        shield: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" fill="none" stroke="currentColor" strokeWidth="2" /></svg>,
        cloud: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z" fill="none" stroke="currentColor" strokeWidth="2" /></svg>,
        code: <svg viewBox="0 0 24 24" fill="currentColor"><polyline points="16 18 22 12 16 6" fill="none" stroke="currentColor" strokeWidth="2" /><polyline points="8 6 2 12 8 18" fill="none" stroke="currentColor" strokeWidth="2" /></svg>,
        star: <svg viewBox="0 0 24 24" fill="currentColor"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" fill="none" stroke="currentColor" strokeWidth="2" /></svg>,
        rocket: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z" fill="none" stroke="currentColor" strokeWidth="2" /><path d="M12 15l-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z" fill="none" stroke="currentColor" strokeWidth="2" /></svg>,
    };
        ...
        <div>
            ...
            <section className="hero">
                ...
                <div className="cloud cloud-1">
                    <svg viewBox="0 0 200 80" fill="rgba(27,145,188,0.25)"><path d="M170 60H30c-16.6 0-30-11.2-30-25s13.4-25 30-25c1.7 0 3.3.1 4.9.4C41.7 4.2 52.4 0 64 0c17.1 0 31.6 10.5 37.3 25.2C105.1 23.1 109.4 22 114 22c13.3 0 24.3 8.7 27.5 20.3 2.8-1.5 6-2.3 9.5-2.3 11 0 20 8.1 20 18s-9 18-20 18h1z" /></svg>
                </div>
                <div className="cloud cloud-2">
                    <svg viewBox="0 0 200 80" fill="rgba(27,145,188,0.18)"><path d="M170 60H30c-16.6 0-30-11.2-30-25s13.4-25 30-25c1.7 0 3.3.1 4.9.4C41.7 4.2 52.4 0 64 0c17.1 0 31.6 10.5 37.3 25.2C105.1 23.1 109.4 22 114 22c13.3 0 24.3 8.7 27.5 20.3 2.8-1.5 6-2.3 9.5-2.3 11 0 20 8.1 20 18s-9 18-20 18h1z" /></svg>
                </div>
                <div className="cloud cloud-3">
                    <svg viewBox="0 0 200 80" fill="rgba(27,145,188,0.22)"><path d="M170 60H30c-16.6 0-30-11.2-30-25s13.4-25 30-25c1.7 0 3.3.1 4.9.4C41.7 4.2 52.4 0 64 0c17.1 0 31.6 10.5 37.3 25.2C105.1 23.1 109.4 22 114 22c13.3 0 24.3 8.7 27.5 20.3 2.8-1.5 6-2.3 9.5-2.3 11 0 20 8.1 20 18s-9 18-20 18h1z" /></svg>
                </div>
                <div className="cloud cloud-4">
                    <svg viewBox="0 0 200 80" fill="rgba(27,145,188,0.15)"><path d="M170 60H30c-16.6 0-30-11.2-30-25s13.4-25 30-25c1.7 0 3.3.1 4.9.4C41.7 4.2 52.4 0 64 0c17.1 0 31.6 10.5 37.3 25.2C105.1 23.1 109.4 22 114 22c13.3 0 24.3 8.7 27.5 20.3 2.8-1.5 6-2.3 9.5-2.3 11 0 20 8.1 20 18s-9 18-20 18h1z" /></svg>
                </div>
                <div className="cloud cloud-5">
                    <svg viewBox="0 0 200 80" fill="rgba(27,145,188,0.30)"><path d="M170 60H30c-16.6 0-30-11.2-30-25s13.4-25 30-25c1.7 0 3.3.1 4.9.4C41.7 4.2 52.4 0 64 0c17.1 0 31.6 10.5 37.3 25.2C105.1 23.1 109.4 22 114 22c13.3 0 24.3 8.7 27.5 20.3 2.8-1.5 6-2.3 9.5-2.3 11 0 20 8.1 20 18s-9 18-20 18h1z" /></svg>
                </div>
                <div className="cloud cloud-6">
                    <svg viewBox="0 0 200 80" fill="rgba(27,145,188,0.20)"><path d="M170 60H30c-16.6 0-30-11.2-30-25s13.4-25 30-25c1.7 0 3.3.1 4.9.4C41.7 4.2 52.4 0 64 0c17.1 0 31.6 10.5 37.3 25.2C105.1 23.1 109.4 22 114 22c13.3 0 24.3 8.7 27.5 20.3 2.8-1.5 6-2.3 9.5-2.3 11 0 20 8.1 20 18s-9 18-20 18h1z" /></svg>
                </div>
                <div className="cloud cloud-7">
                    <svg viewBox="0 0 200 80" fill="rgba(27,145,188,0.15)"><path d="M170 60H30c-16.6 0-30-11.2-30-25s13.4-25 30-25c1.7 0 3.3.1 4.9.4C41.7 4.2 52.4 0 64 0c17.1 0 31.6 10.5 37.3 25.2C105.1 23.1 109.4 22 114 22c13.3 0 24.3 8.7 27.5 20.3 2.8-1.5 6-2.3 9.5-2.3 11 0 20 8.1 20 18s-9 18-20 18h1z" /></svg>
                </div>
                <div className="cloud cloud-8">
                    <svg viewBox="0 0 200 80" fill="rgba(27,145,188,0.28)"><path d="M170 60H30c-16.6 0-30-11.2-30-25s13.4-25 30-25c1.7 0 3.3.1 4.9.4C41.7 4.2 52.4 0 64 0c17.1 0 31.6 10.5 37.3 25.2C105.1 23.1 109.4 22 114 22c13.3 0 24.3 8.7 27.5 20.3 2.8-1.5 6-2.3 9.5-2.3 11 0 20 8.1 20 18s-9 18-20 18h1z" /></svg>
                </div>
                <div className="cloud cloud-9">
                    <svg viewBox="0 0 200 80" fill="rgba(27,145,188,0.12)"><path d="M170 60H30c-16.6 0-30-11.2-30-25s13.4-25 30-25c1.7 0 3.3.1 4.9.4C41.7 4.2 52.4 0 64 0c17.1 0 31.6 10.5 37.3 25.2C105.1 23.1 109.4 22 114 22c13.3 0 24.3 8.7 27.5 20.3 2.8-1.5 6-2.3 9.5-2.3 11 0 20 8.1 20 18s-9 18-20 18h1z" /></svg>
                </div>
                <div className="cloud cloud-10">
                    <svg viewBox="0 0 200 80" fill="rgba(27,145,188,0.24)"><path d="M170 60H30c-16.6 0-30-11.2-30-25s13.4-25 30-25c1.7 0 3.3.1 4.9.4C41.7 4.2 52.4 0 64 0c17.1 0 31.6 10.5 37.3 25.2C105.1 23.1 109.4 22 114 22c13.3 0 24.3 8.7 27.5 20.3 2.8-1.5 6-2.3 9.5-2.3 11 0 20 8.1 20 18s-9 18-20 18h1z" /></svg>
                </div>
                ...
                <div className="container">
                    <div className="hero-content">
                        <div className="hero-badge">
                            ...
                            {hero.badge_text || "Leading technology solutions for your success"}
                        </div>
                        <h1>
                            {hero.title_line1}{' '}
            ...
            <section className="services-section">
                <div className="container">
                    <div className="services-header reveal reveal-up">
                        ...
                        <h2 className="section-title">Innovative IT Solutions</h2>
                    ...
                    <div className="services-grid">
                        {services.map((service, idx) => (
                            <div className={`service-card reveal reveal-up delay-${(idx % 4 + 1) * 100}`} key={service.id}>
            ...
            <section className="portfolio-section">
                <div className="container">
                    <div className="portfolio-header reveal reveal-up">
                    ...
                    <div className="portfolio-grid">
                        {portfolio.map((item, idx) => (
                            <div className={`portfolio-card reveal reveal-up delay-${(idx % 3 + 1) * 100}`} key={item.id}>
                                {item.image ? (
                ...
                <div className="container">
                    ...
                    <div className="testimonials-grid">
                        {testimonials.map((t, idx) => (
                            <div className={`testimonial-card reveal reveal-up delay-${(idx % 3 + 1) * 100}`} key={t.id}>
